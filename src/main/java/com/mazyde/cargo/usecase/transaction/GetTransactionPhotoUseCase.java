...
public class GetTransactionPhotoUseCase {
    ...
    public TransactionDto getTransactionDetail(Long transactionId) {
        ...
        Transaction transaction = transactionQueryGateway.findById(transactionId);

        TransactionPhoto photo = transactionPhotoQueryGateway.findFirstByTransactionId(transactionId);
